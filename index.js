...
app.post('/update', async (req, res) => {
	...
	try {
		if (req.body.choix && req.body.montant && req.body.lieu) {
			console.log('la');
			const user = await Users.findById(req.body.choix);
			const add = {
				montant: req.body.montant,
				lieu: req.body.lieu
			};
			console.log('req', req.body.montant);

			user.total = user.total + parseInt(req.body.montant);
